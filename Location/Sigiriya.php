...
<html>
    <head>
        ...
        <title>Travaliac_Location_Sigiriya</title>
...
<section class="test">
    <div class="box-container">
       <div class="box">
            <h3>Way To Sigiriya</h3><br>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.4049842896766!2d80.760257!3d7.957032699999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3afca15b724c9ab3%3A0xab1771275b370d52!2sSigiriya!5e0!3m2!1sen!2slk!4v1696345263997!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
       <div class="box">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <li><img src="../Images/Sigiriyatrain.png" class="train"></li>
        </div>
        <div class="box">
            <h3>Places to Visit</h3><br>
            <ol><br>
                <li><a href="https://maps.app.goo.gl/v4bPXYmhEa7wZzFT8" target="_blank">Sigiriya Rock</a></li><br>
                <li><a href="https://maps.app.goo.gl/Rm6ugEWniT3ooBjE7" target="_blank">Pidurangala</a></li><br>
                <li><a href="https://maps.app.goo.gl/tYx7ttZ5jaMd9SXh9" target="_blank">Ravana's palace</a></li><br>
                <li><a href="https://maps.app.goo.gl/7nszfiTY9rBkDsfw7" target="_blank">Cobra Hood Cave</a></li><br>
                <li><a href="https://maps.app.goo.gl/VXvvJihws5ppRiTe7" target="_blank">Dambulla Royal Cave Temple</a></li>
            </ol>
        </div>
     </div>
   </section>
   ...
   <section class="hotels">
    ...
    <div class="hotel-container">
        <div class="hotel">
            <h4>Aliya Resort & spa</h4>
            <a href="../Stays/Hotel1.php"><img src="../Images/araliya3.jpg"></a>
        </div>
        <div class="hotel">
            <h4>Royal vila</h4>
